...
{
    int[] midGamePieceValues = { 0, 1025, 365, 337, 477, 82 };
    int[] endGamePieceValues = { 0, 936, 297, 281, 512, 94 };
    ...
    public int EvaluatePosition(Board board, bool isWhite)
    {
        ...
        for (int piece = 0; piece < bitboards.Length; piece++)
        {
            ...
            if (piece < 6) whiteMaterial += addEvalAmount;
            else blackMaterial += addEvalAmount;
        }
        ...
        bool whiteIsWinning = whiteMaterial > blackMaterial;
        ...
        evaluation += sign * ForceKingToCornerEval(strongKingSquare, weakKingSquare, endgameWeight);
